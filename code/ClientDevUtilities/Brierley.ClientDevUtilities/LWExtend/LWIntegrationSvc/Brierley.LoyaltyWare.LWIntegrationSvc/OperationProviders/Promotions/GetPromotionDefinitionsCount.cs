...
{
    public class GetPromotionDefinitionsCount : OperationProviderBase
    {
        #region Fields
        //private const string _className = "GetPromotionDefinitionsCount";
        //private static LWLogger _logger = LWLoggerManager.GetLogger(LWConstants.LW_LWINTEGRATION_SERVICE);
        #endregion

        #region Construction
        public GetPromotionDefinitionsCount() : base("GetPromotionDefinitionsCount") { }
        #endregion
        ...
        {            
            try
            {
                ...
                int count = ContentService.HowManyPromotions(parmsList);
