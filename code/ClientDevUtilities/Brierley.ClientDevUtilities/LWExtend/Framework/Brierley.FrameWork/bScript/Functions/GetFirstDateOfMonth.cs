...
namespace Brierley.FrameWork.bScript.Functions
{
    ...
    [Serializable]
	[ExpressionContext(Description = "Returns the date corresponding to the first day of the month for the specified date.",
		DisplayName = "GetFirstDateOfMonth",
		ExcludeContext = 0,
    ...
    public class GetFirstDateOfMonth : UnaryOperation
    {
        ...
        {
            get { return "GetFirstDateOfMonth(['date']|[Date()]|date expression)"; }
        }
        ...
        internal GetFirstDateOfMonth(Expression rhs)
            : base("GetFirstDateOfMonth", rhs)
        {
        }
        ...
        public override object evaluate(ContextObject contextObject)
        {
            ...
            {
                throw new CRMException("The GetFirstDateOfMonth function requires a date parameter. " + ex.Message);
            }
        }        
    }
}
