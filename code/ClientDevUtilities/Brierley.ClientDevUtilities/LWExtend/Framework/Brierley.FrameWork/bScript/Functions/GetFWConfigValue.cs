...
namespace Brierley.FrameWork.bScript.Functions
{
    ...
    /// </example>
    [Serializable]
    [ExpressionContext(Description = "Returns the string value from the framework configuration store that has the key value matching the value supplied by ConfigurationKeyName.",
        DisplayName = "GetFrameworkConfigValue",
        ExcludeContext = 0,
        ...
        WizardDescription = "Framework configuration store value",
        AdvancedWizard = true
        )]
    ...
    public class GetFrameworkConfigValue : UnaryOperation
    {
        private string _className = "GetFrameworkConfigValue";
        LWLogger _logger = LWLoggerManager.GetLogger(LWConstants.LW_FRAMEWORK);
        /// <summary>
        /// Public Constructor
        /// </summary>
        public GetFrameworkConfigValue()
        {
        ...
        internal GetFrameworkConfigValue(Expression rhs)
            : base("GetFrameworkConfigValue", rhs)
        {
        }
        ...
        public new string Syntax
        {
            get
            {
                return "GetFrameworkConfigValue('ConfigurationKeyName')";
            }
        }
        ...
        public override object evaluate(ContextObject contextObject)
        {
            ...
            try
            {
                string value = LWConfigurationUtil.GetConfigurationValue(keyName); ;
