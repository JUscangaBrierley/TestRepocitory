...
{
	[Serializable]
	public class AwardPoints : RuleBase
	{
		[NonSerialized]
		private const string _className = "AwardPoints";
		...
		private bool _putPointsOnHold = false;
		...
		[Browsable(true)]
		[CategoryAttribute("General")]
		[DisplayName("Put Points On Hold")]
		[Description("If this is checked, then the points awarded will be put on hold.")]
		[RulePropertyOrder(16)]
		[RuleProperty(false, false, false, null, false, true)]
		public bool PutPointsOnHold
		{
			get
			{
				return _putPointsOnHold;
			}
			set
			{
				_putPointsOnHold = value;
			}
		}
		...
		public override RuleBase MigrateRuleInstance(RuleBase source, ServiceConfig sourceConfig, ServiceConfig targetConfig)
		{
			...
			AwardPoints src = (AwardPoints)source;
			...
			PutPointsOnHold = src.PutPointsOnHold;
