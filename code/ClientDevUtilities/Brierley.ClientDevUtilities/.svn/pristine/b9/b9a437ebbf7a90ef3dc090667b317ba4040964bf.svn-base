...
{
    public class GetMemberRewardSummaryByCert : MemberRewardsBase
    {
        public GetMemberRewardSummaryByCert() : base("GetMemberRewardSummaryByCert") { }
        ...
        public override string Invoke(string source, string parms)
        {
            try
            {
                ...
                string certNmbr = (string)args["CertNumber"];
                ...
                MemberReward reward = LoyaltyDataService.GetMemberRewardByCert(certNmbr);

                if (reward == null)
                {
                    throw new LWOperationInvocationException("No reward found with cert " + certNmbr + ".") { ErrorCode = 3347 };
                }
