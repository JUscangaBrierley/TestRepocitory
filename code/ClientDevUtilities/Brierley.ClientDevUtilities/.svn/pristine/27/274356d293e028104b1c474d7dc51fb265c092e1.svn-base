...
{
	public class ReferralCompleted : OperationProviderBase
	{
		...
		public ReferralCompleted()
			: base("ReferralCompleted")
		{
		}
		...
		public override object Invoke(string source, WcfAuthenticationToken token, object[] parameters)
		{
			...
			{
				string errMsg = "Invalid parameters provided for ReferralCompleted.";
			...
			RfeUtil.ProcessBonusAction(bonusId, null, null, null, null, awardPointRule, true);
			return null;
		}
	}
}