...
namespace Brierley.FrameWork.bScript.Functions
{
	[ExpressionContext(Description = "Returns string containing an html 'img' tag for the provided image in the image store.",
		...
		WizardDescription = "HTML Image",
		AdvancedWizard = true)]
	[ExpressionParameter(Order = 1, Name = "ImageName", Type = ExpressionApplications.Strings, Optional = false, WizardDescription = "Image Name")]
	public class HtmlImage : UnaryOperation
	{
		...
		public HtmlImage(Expression rhs)
			: base("HtmlImage", rhs)
		{
		}
		...
		public override object evaluate(ContextObject contextObject)
		{
			...
			string result = string.Format("<img alt=\"\" style=\"border-width: 0px;\" src=\"{0}\" />", MakeImageUrl());
			return result;
		}
	}
}
