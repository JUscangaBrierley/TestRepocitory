...
namespace Brierley.FrameWork.bScript.Functions
{
    ...
    [Serializable]
	[ExpressionContext(Description = "Returns the date corresponding to the last day of the month for the specified date.",
		DisplayName = "GetLastDateOfMonth",
		ExcludeContext = 0,
    ...
    public class GetLastDateOfMonth : UnaryOperation
    {
        ...
        {
            get { return "GetLastDateOfMonth(['date']|[Date()]|date expression)"; }
        }
        ...
        internal GetLastDateOfMonth(Expression rhs)
            : base("GetLastDateOfMonth", rhs)
        {
        }
        ...
        public override object evaluate(ContextObject contextObject)
        {
            ...
            {
                throw new CRMException("The GetLastDateOfMonth function requires a date parameter. " + ex.Message);
            }
        }        
    }
}
