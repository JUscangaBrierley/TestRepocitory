...
public class MemberRewardOrderStruct {
	...
	// property: MemberRewardInfo
	@LWIsRequired       								
	private MemberRewardInfoStruct[] MemberRewardInfo;
	public 	MemberRewardInfoStruct[] getMemberRewardInfo() {
		return this.MemberRewardInfo;
	}
	public 	void setMemberRewardInfo(MemberRewardInfoStruct[] MemberRewardInfo) {
		this.MemberRewardInfo = MemberRewardInfo;
	}	
