...
public class RefLanguagePref extends LWClientDataObject {			    
	// property: LanguagePrefCode
	
	private Long LanguagePrefCode;
	public 	Long getLanguagePrefCode() {
		return this.LanguagePrefCode;
	}
	public 	void setLanguagePrefCode(Long languageprefcode) {
