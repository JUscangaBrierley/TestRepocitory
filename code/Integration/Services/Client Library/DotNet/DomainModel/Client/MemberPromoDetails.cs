...
{
	public class MemberPromoDetails : LWClientDataObject
	{							    											    
		#region Properties
		[LWMeta(false)]				
		public virtual int? TxnBraNet { get; set; }			
		[LWMeta(false)]				
		public virtual int? TxnJeanNet { get; set; }			
		[LWMeta(false,1)]				
		public virtual string IsCurrentEmployee { get; set; }			
		#endregion				
	}
}
