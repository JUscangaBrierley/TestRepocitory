<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewTierHistory.ascx.cs" Inherits="Brierley.LWModules.TierHistory.ViewTierHistory" %>
...
<asp:Panel runat="server" ID="pnlTierHistory">
    <div id="TierHistoryContainer">
        ...
        <asp:PlaceHolder ID="phTierHistory" runat="server" Visible="true" />
