...
<script type="text/javascript">
    function CouponAppeasementCancelClick() {
        ...
        $('#<%=ddlCoupon.ClientID%>').removeClass('ValidatorInvalid');
...
<div id="CouponAppeasementContainer">
	...
	<div class="ActionButtons">
		...
		<asp:LinkButton ID="btnCancel" runat="server" meta:resourcekey="btnCancel" CausesValidation="false" OnClientClick="return CouponAppeasementCancelClick();" />
	</div>
</div>