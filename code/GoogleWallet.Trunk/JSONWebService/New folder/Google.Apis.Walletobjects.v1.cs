...
//     Build date: 2013-09-16 16:24:00 UTC
//     on: 2013-10-17, 17:49:31 UTC
//     C# generater version: 
//
...
{    
    ...
    {
        /// <summary>Human-readable text to display to the user. This is displayed in addition to the encoded barcode
        /// value for use when the barcode cannot be scanned.</summary>
        ...
        /// <summary>Barcode type. Allowed values: - aztec - code39 - code128 - codabar - dataMatrix: Is 2D matrix
        /// barcode consisting of black and white. Cells or modules arranged in either a square or rectangular pattern.
        /// - ean8 - ean13 - itf14 - pdf417 - qrCode - textOnly: Will render the given value field as a text field. Note
        /// that alternateText field may not be used with a barcode of type textOnly. - upcA</summary>
    ...
    public class BoardingPassClass : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The unique identifier for a class. This ID be unique across all classes from an issuer. This value
        /// should follow the format .<identifier(chosen by you)>. Your unique identifier should only include
        /// alphanumeric characters, '_' or '-'.</summary>
        ...
        /// <summary>The list of locations where the Wallet Object can be used. The Wallet Object platform will use this
        /// information to trigger geolocated notifications to users. Note that locations in the object will be used
        /// over locations in the class which will be used over locations in the Google Places ID.</summary>
        ...
        ///
        /// You should should set this field to underReview when you believe the class is ready for review. An
        /// underReview class has the same visibility as a draft class, but is automatically sent to Google for
        /// approval.
        ///
        ...
        ///
        /// Note that the Wallet Objects Platform increments the version of the class when the review status is changed
    ...
    {
        /// <summary>Mask that specifies the fields that should be set in the returned resource</summary>
    ...
    /// <summary>Fields that should be retrieved or updated for a given operation. A mask can be either specified as a
    /// recursive set of fields, or using one of the projection defined for this resource collection.</summary>
    public class BoardingPassClassMask : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Identifies the fields that should be retrieved or updated. The field projection should not be set
        /// when field masks are added</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("fields")]
        public virtual System.Collections.Generic.IList<FieldMask> Fields { get; set; } 

        /// <summary>When set, specifies which fields should be retrieved or updated using a predefined mask that is
        /// specific to this resource collection.</summary>
    ...
    public class BoardingPassObject : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The unique identifier for an object. Must be unique across all classes from an issuer. This value
        /// should follow the format .<identifier(chosen by you)>. The unique identifier should only include
        /// alphanumeric characters, '_' or '-'.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("id")]
        public virtual string Id { get; set; } 
    ...
    /// <summary>Images to render in the Image Module.</summary>
    ...
    /// <summary>Data to render in the Info Module.</summary>
    public class InfoModuleData : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Background color for the Info Module. format - #hhhhhh where h is a hex digit</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("hexBackgroundColor")]
        public virtual string HexBackgroundColor { get; set; } 

        /// <summary>Color for the font in the Info Module. format - #hhhhhh where h is a hex digit</summary>
    ...
    public class LabelValueRow : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Background color for the row. format - #hhhhhh where h is a hex digit</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("hexBackgroundColor")]
        public virtual string HexBackgroundColor { get; set; } 

        /// <summary>Color for the font in this row. format - #hhhhhh where h is a hex digit</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("hexFontColor")]
        public virtual string HexFontColor { get; set; } 
    ...
    public class LatLongPoint : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Latitude can be specified as any value in the range of -90.0 through +90.0, both inclusive. Values
        /// outside these bounds will be rejected.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("latitude")]
        public virtual System.Nullable<double> Latitude { get; set; } 

        /// <summary>Longitude can be specified in the range -180.0 through +180.0, both inclusive. Values outside these
    ...
    /// <summary>URIs to render in the Links module. URIs are displayed in the order provided and after the home page
    /// URI.</summary>
    ...
    public class LoyaltyClass : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The program name, such as "Adam's Apparel". The Google Wallet app will display an ellipse after the
        ...
        /// <summary>The rewards tier, such as"Gold" or "Platinum." Recommended maximum length is 7 characters to ensure
        /// full string is displayed on smaller screens.</summary>
    ...
    {
        /// <summary>The resources list return is implied</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("pagination")]
        public virtual Pagination Pagination { get; set; } 
    ...
    public class LoyaltyObject : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Image Module data.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("imageModuleDatas")]
        public virtual System.Collections.Generic.IList<ImageModuleData> ImageModuleDatas { get; set; } 

        /// <summary>Info Module data.</summary>
        ...
        /// <summary>Links module data.</summary>
        ...
        /// <summary>Text Module data.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("textModuleDatas")]
        public virtual System.Collections.Generic.IList<TextModuleData> TextModuleDatas { get; set; } 
    ...
    {
        /// <summary>The kind, fixed to "walletobjects#pagination".</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kind")]
        public virtual string Kind { get; set; } 
    ...
    {
        /// <summary>For each named view, this is the corresponding template family used to render the fetched Wallet
        /// Object. For example, view name "g_expanded" might be mapped to 1.loyaltyCard1_expanded".</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("templateFamily")]
        public virtual string TemplateFamily { get; set; } 

        /// <summary>Each view (currently g_list, g_expanded) determines the template family to use to display Wallet
        /// Objects associated with the containing Wallet class. Typically, these views are mapped to canned template
        /// family names.</summary>
    ...
    /// <summary>Header and body text to display in the Text Module.</summary>
    ...
    {
        /// <summary>End time of the interval. A RFC 3339 formatted date-time. For example, 1985-04-12T23:20:50.52Z
        /// would be 20 minutes and 50.52 seconds after the 23rd hour of April 12th, 1985, in UTC.</summary>
        ...
        /// <summary>Start time of the interval. A RFC 3339 formatted date-time. For example, 1985-04-12T23:20:50.52Z
        /// would be 20 minutes and 50.52 seconds after the 23rd hour of April 12th, 1985, in UTC.</summary>
    ...
    {
        /// <summary>The URI's human-readable description, which will appear in the user facing app as text. This
        /// property is optional. Recommended maximum is 20 characters.
        ///
        ...
        /// <summary>If users click on the message, they will be directed to this URI.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("uri")]
    ...
    {
        /// <summary>You can set a URI to which users are directed when they click on the message.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("actionUri")]
        public virtual Uri ActionUri { get; set; } 

        /// <summary>The message body which is displayed to the user. This can only plain text. The maximum is 200
        /// characters, or 150 characters if you specify an image.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("body")]
        public virtual string Body { get; set; } 

        /// <summary>Controls when the message will be displayed to customers.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("displayInterval")]
        public virtual TimeInterval DisplayInterval { get; set; } 

        /// <summary>The message header which is displayed to the user. The maximum is 35 characters, or 25 characters
        /// if you specify an image.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("header")]
        public virtual string Header { get; set; } 

        /// <summary>Image to display with the message.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("image")]
        public virtual Image Image { get; set; } 
...
namespace Google.Apis.Walletobjects.v1
{
    ...
    public class BoardingpassclassResource
    {
        ...
        public class GetRequest : WalletobjectsBaseServiceRequest<Google.Apis.Walletobjects.v1.Data.BoardingPassClass>
        {
            ...
            /// <summary>Returns class for specified version. If not specified, returns the latest class
            /// version.</summary>
            [Google.Apis.Util.RequestParameterAttribute("version", Google.Apis.Util.RequestParameterType.Query)]
            public virtual string Version { get; set; }

            /// <summary>Returns latest class version with review_status = APPROVED. approved_only and version cannot be
            /// both set.</summary>
            /// [default: false]
        ...
        /// <param name="issuerId">Returns a paginated list of classes issued by issuer_id that the caller is authorized to
        /// read. No type field, as that is implicate in the type part of the Uri.</param>
        ...
        public class ListRequest : WalletobjectsBaseServiceRequest<Google.Apis.Walletobjects.v1.Data.BoardingPassClassListResponse>
        {
            ...
            /// <summary>Returns a paginated list of classes issued by issuer_id that the caller is authorized to read.
            /// No type field, as that is implicate in the type part of the Uri.</summary>
            ...
            /// <summary>We create our own pagination here because protiary + rosy pagination to not work
            /// together</summary>
    ...
    public class BoardingpassobjectResource
    {
        ...
        /// <param name="classId">Returns a paginated list of instances that reference the specified class.</param>
        ...
        public class ListRequest : WalletobjectsBaseServiceRequest<Google.Apis.Walletobjects.v1.Data.BoardingPassObjectListResponse>
        {
            ...
            /// <summary>Returns a paginated list of instances that reference the specified class.</summary>
