...
namespace BuildTestFiles
{
    public class GEEnrollment
    {
        ...
        private string BuildRecord(GEEnrollmentRecordClass AERec)
        {
            ...
            sb.Append(Global.MakeFixedLength(AERec.FirstName, 15, " "));
            sb.Append(Global.MakeFixedLength(AERec.MiddleName, 1, " "));
            sb.Append(Global.MakeFixedLength(AERec.LastName, 30, " "));
            sb.Append(Global.MakeFixedLength(AERec.Address1, 35, " "));
            sb.Append(Global.MakeFixedLength(AERec.Address2, 35, " "));
            sb.Append(Global.MakeFixedLength(AERec.City, 25, " "));
            ...
            sb.Append(Global.MakeFixedLength(AERec.EmailAddress, 50, " "));
