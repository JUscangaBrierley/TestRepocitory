...
namespace BuildTestFiles
{
    public class POSEnrollment
    {
        ...
        private string BuildRecord(POSEnrollmentRecordClass AERec)
        {
            ...
            sb.Append(Global.MakeFixedLength(AERec.FirstName, 14, " "));
            ...
            sb.Append(Global.MakeFixedLength(AERec.City, 20, " "));
            ...
            sb.Append(Global.MakeFixedLength(DateTime.Parse(AERec.BirthDate).ToString("MMddyy"), 6, " "));
            sb.Append(Global.MakeFixedLength(AERec.Gender, 1, " "));
            sb.Append(Global.MakeFixedLength(AERec.EmailAddress, 100, " "));
