...
namespace AmericanEagle.SDK.Global
{
        ...
        public enum EmailType
        {
            ...
            EnrollActivate = 9,
            DollarRewardAppeasementReward = 10, //PI31161 changes for new Dollarreward appeasement  -scj
            MergeAccounts = 11, // AEO-Redesign-2014
            /* AEO-218 Begin*/
            PointsReward = 12,
            PointsNoReward = 13,
            /* AEO-218 End */
            ...
            /*AEO-219 End */
            /*AEO-489 Begin------------SCJ*/
            B5G1JeanAppeasementEmail = 16,
            FiveDollarRwdAppeasementEmail = 17,
            /*AEO-489 End------------SCJ*/
            BirthdayAppeasementEmail = 18,
            LegacyRewardEmail = 19,
			ChooseYourOwnSaleDayAppeasement20Email = 20 /*AEO-2389 [Rule]20ChooseYourOwnSaleDayAppeasementEmail*/
        }
        ...
        public enum CardReplaceStatus
        {
            ...
            Replaced = 3,
            SendToAE = 4, // added for redesign project
        }
        ...
        public enum ResponseCode
        {
            ...
            TransactionFinalSaleAmountRequired = 640,
            InvalidFinalSalePrice = 650,
            TenderAmountRequired = 870
        }
            ...
            public static string GetResponseMessage(ResponseCode responseCode)
            {
                ...
                switch (responseCode)
                {
                    ...
                    case ResponseCode.RequestPointsTransactionAlreadyPosted:
                        ...
                        break;
                    case ResponseCode.TransactionFinalSaleAmountRequired:
                        returnMessage = "Final Sale Price Required";   // Response Code: 640
                        break;
                    case ResponseCode.InvalidFinalSalePrice:
                        returnMessage = "Final Sale Price Invalid"; // Response Code: 650
                        break;
                    case ResponseCode.TenderAmountRequired: 
                        returnMessage = "Tender Amount Required";   // Response Code: 870
                        break;
                    default:
