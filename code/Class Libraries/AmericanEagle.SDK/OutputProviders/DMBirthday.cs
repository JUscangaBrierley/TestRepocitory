...
{
    public class DMBirthday : IDAPOutputProvider
    {
        ...
        private string outfilename = "AEORW_DM_Brthday_YYYYMMDDHHMMSS.txt";
        ...
        private  string typeCode = "CREDDMBDAY20";
        ...
        public void Initialize ( System.Collections.Specialized.NameValueCollection globals, System.Collections.Specialized.NameValueCollection args, long jobId, DAPDirectives config, System.Collections.Specialized.NameValueCollection parameters, DAPPerformanceCounterUtil performUtil )
        {
            ...
            outfilename = path+ outfilename.Replace("YYYYMMDDHHMMSS", this.processDate.ToString("yyyyMMddHHmmss"));

            string[] files = { outfilename };
        ...
        public void ProcessMessageBatch ( IList<string> messageBatch )
        {
            ...
            try
            {
                ...
                XmlNode xmlNode = doc.SelectSingleNode("DirectMailBirthday/Global");
                foreach ( XmlNode node in xmlNode.ChildNodes )
                {
                    switch ( node.Name.ToUpper() )
                    {
                        ...
                        case "LOYALTYIDNUMBER":
                            strLoyaltyNumber = node.InnerText.Trim();
                            break;
                ...
                if ( xmlNode != null )
                {
                    if ( strLoyaltyNumber.Length > 0 )
                    {
                        ...
                        else
                        {
                            ...
                            ExecuteRule(member, "BirthdayDM", out memberRewardIDs);
                            ...
                            foreach (long memberRewardId in memberRewardIDs)
                            {
                                ...
                                fileLine.CUSTOMER_NBR = linkkey;
                                 fileLine.LOYALTY_NUMBER= strLoyaltyNumber;
