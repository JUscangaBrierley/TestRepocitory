...
namespace AmericanEagle.SDK.OutputProviders
{
    ...
    /// </summary>
    public class VendorEmailEventError : IDAPOutputProvider
    {
        /// <summary>
        ...
        //private string strEventID = string.Empty;
        /// <summary>
        /// Stores the EventID that is to be changed
        /// </summary>
        private string strEventID  = string.Empty;
                ...
                if (null != xmlNode)
                  {
                      ...
                      strEventID = (xmlNode.Attributes["eid"].Value).Trim().ToLower();
                     ...
                     if (!string.IsNullOrEmpty(strLoyaltyNumber))
                      {
                          ...
                          if (memberDetails != null  )
                            {
                                    ClientConfiguration objClientConfiguration = LWDataServiceUtil.DataServiceInstance(true).GetClientConfiguration("EID_EmailReward");
                                    string _strEmailReward = Convert.ToString(objClientConfiguration.Value);

                                    ClientConfiguration objClientConfiguration2 = LWDataServiceUtil.DataServiceInstance(true).GetClientConfiguration("EID_EmailBraReward");
                                    string _strEmailBraReward = Convert.ToString(objClientConfiguration2.Value);

                                    ClientConfiguration objClientConfiguration3 = LWDataServiceUtil.DataServiceInstance(true).GetClientConfiguration("EID_EmailJeanReward");
                                    string _strEmailJeansReward = Convert.ToString(objClientConfiguration3.Value);

                                    memberDetails.PendingEmailVerification = 1;
                                    memberDetails.NextEmailReminderDate = null;
                                    memberDetails.PassValidation = false;
                                    ...
                                    if ((strEventID == _strEmailReward) && (memberDetails.PendingCellVerification != 0))
                                    {
                                        string _pointType = "AEO Connected Points";
                                    ...
                                    else if ((strEventID == _strEmailBraReward) && (memberDetails.PendingCellVerification != 0))
                                    {
                                    ...
                                    else if ((strEventID == _strEmailJeansReward) && (memberDetails.PendingCellVerification != 0))
                                    {
