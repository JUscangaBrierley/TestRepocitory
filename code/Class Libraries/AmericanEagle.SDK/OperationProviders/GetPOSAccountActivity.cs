...
namespace AmericanEagle.SDK.OperationProviders
{
    ...
    /// </summary>
    public class AEPOSGetAccountActivity : OperationProviderBase
    {
        #region Fields
        /// <summary>
        ...
        /// </summary>
        public AEPOSGetAccountActivity()
            : base("AEPOSGetAccountActivity")
        {
        }
        #endregion
        ...
        private void GetTxnHistory(string[] rowKeys, ref IList<TransactionHeaderInternal> header, VirtualCard virtualCard)
        {
            ...
            {
                logger.Error("AEPOSGetAccountActivity", "GetTxnHistory", ex.Message);
            }
        }
        private void LoadAccountActivityData(Member member, DateTime _startDate, DateTime _endDate, int pageNumber, out IList<TransactionHeaderInternal> _headers)
        {
            ...
            IList<IClientDataObject> txnHeaders = AccountActivityUtil.GetAccountActivitySummary(member, _startDate, _endDate, true, Utilities.IncludeExpired(_startDate, member), null);
            ...
            //LW 4.1.14 change
            //IList<PointTransaction> filteredList = AccountActivityUtil.GetOtherPointsHistory(member, _startDate, _endDate, null, null, new LWQueryBatchInfo() { BatchSize = 10, StartIndex = pageNumber });
            ...
            IList<PointTransaction> filteredList = _LoyaltyData.GetPointTransactionsByPointTypePointEvent(member, _startDate, _endDate, null, pointTypeIDs, null, Brierley.FrameWork.Common.PointTransactionOwnerType.Unknown, -1, null, Utilities.IncludeExpired(_startDate, member), null);
        ...
        private ResponseCode ValidateInputs(APIArguments args, ILoyaltyDataService dataservice, out int totalPageCount, out IList<TransactionHeaderInternal> headers, out string loyaltyIdNumber)
        {
            ...
            if (member != null)
            {
                ...
                // AEO-74 Upgrade 4.5 changes here -----------SCJ
                var pointTxnCount = dataservice.GetPointTransactions(member, startDate, endDate,null, null, 0, 999999, Utilities.IncludeExpired(startDate, member));
