...
{
    class SendRequestCreditEmailInterceptor : IInboundInterceptor
    {
        #region Fields
        ...
        private static LWLogger logger = LWLoggerManager.GetLogger("SendRequestCreditEmailInterceptor");
        #endregion
        ...
        public virtual Member ProcessMemberBeforeSave(LWIntegrationConfig config, Member member, XElement memberNode)
        {
            ...
            EmailType emailType = EmailType.RequestCreditReceiptFound;
